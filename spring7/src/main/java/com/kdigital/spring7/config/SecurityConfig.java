...
public class SecurityConfig {
	...
	private final LoginFailureHandler failureHandler;  // 실패할 때 처리할 객체
	private final LoginSuccessHandler successHanler; // 로그인 성공 시 처리할 객체
	...
	SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http
			.formLogin((auth) -> auth
					...
					.successHandler(successHanler)      // 로그인 성공시 처리할 핸들러 등록
